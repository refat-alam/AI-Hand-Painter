...
cap = cv2.VideoCapture(0) #value change according to webcam devices#
cap.set(3, 1280)  #image size#
cap.set(4, 720)
detector = HandDetector(detectionCon=0.8) # ACCURACY#

#Mcq part, can add more choices#
class MCQ():
    def __init__(self, data):
        ...
        self.userAns = None
#choice update after click part#
...
while True:
    ...
    if qNo < qTotal:
        mcq = mcqList[qNo]
# mcq and choices size and others organize, borders#
...
# hands click box part#
    ...
    cv2.rectangle(img, (150, 600), (barValue, 650), (255, 153, 102), cv2.FILLED)
